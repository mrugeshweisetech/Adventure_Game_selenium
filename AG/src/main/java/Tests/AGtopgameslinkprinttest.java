...
public class AGtopgameslinkprinttest {
    ...
    public void printAllValidLinks() {
        test = extent.createTest("Print All Valid Links - Recurring Articles Page");
        ...
        try {
            ...
            test.info("Total valid unique links printed: " + uniqueLinks.size());

        } catch (Exception e) {
            test.fail(" Exception while printing links: " + e.getMessage());
        }
    }
